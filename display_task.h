...
typedef enum _DISPLAY_EVENTS_
{
  ...
  DISP_EVENT_MICSxx14_SENSOR_INIT,
  DISP_EVENT_MICSxx14_SENSOR_OKAY,
  DISP_EVENT_MICSxx14_VALUES_OKAY,
  DISP_EVENT_MICSxx14_DEF_SETTING,
  DISP_EVENT_MICSxx14_DONE,
  DISP_EVENT_MICSxx14_SENSOR_ERR,
  DISP_EVENT_MICSxx14_HEATING_UP,
  ...
  DISP_EVENT_FOTA_IN_PROGRESS,

  // network cases
  DISP_EVENT_CONN_TO_WIFI,
  DISP_EVENT_CONN_TO_GPRS,
  DISP_EVENT_RETRIEVE_DATETIME,
